...
public class FirstPersonController : MonoBehaviour
{
    ...
    public float sprintBarWidthPercent = 0.335f;
    public float sprintBarHeightPercent = 0.15f;
        ...
        if (enableSprint)
        {
            ...
            if (useSprintBar && !unlimitedSprint)
            {
                ...
                else
                {
                    if (sprintBarCG != null)
                    {
                        sprintBarCG.alpha = Mathf.Lerp(sprintBarCG.alpha, 1, 3 * Time.deltaTime);
                    }
                }
            }
        }
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(fpc.useSprintBar)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            fpc.sprintBarHeightPercent = EditorGUILayout.Slider(new GUIContent("Bar Height", "Determines the height of the sprint bar."), fpc.sprintBarHeightPercent, .001f, 1f);
            EditorGUILayout.EndHorizontal();
            EditorGUI.indentLevel--;
        }
        GUI.enabled = true;
